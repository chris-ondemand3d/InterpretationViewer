...
QtObject{
  property QtObject mainwindow: QtObject{
    property int _module_menu_width: 75
    property int _module_menu_title_font_pointSize: 10
  ...
  property QtObject i2gwindow: QtObject{
    property int _i2g_title_font_pointSize: 9
    property int _i2g_text_overlay_font_pointSize: 9
  ...
  property QtObject dbmwindow: QtObject{
    property int _db_title_font_pointSize: 14
...
//    NOTE tooltip test
  ...
  property QtObject dentaldummy: QtObject{
    ...
    property int _tools_title_label_size: 10
    ...
    property int _quickview_title_font_pointSize: 9
    ...
    //Tasks!!!!
    property int _tools_tasks_label_size: 10
    property color _tools_tasks_line_color: "#282828"
    property int _registration_dialog_title_font_pointSize: 11
    property int _registration_dialog_subtitle_font_pointSize: 10
  }
  ...
  property QtObject leafimplantitem: QtObject{
    property int _title_font_pointSize: 11
    property int _subtitle_font_pointSize: 10
    property int _title_text_width : 80
    property int _title_text_height : 20
  }

  property QtObject project_save_dialog: QtObject{
    property int _title_font_pointSize: 10
  }
}
